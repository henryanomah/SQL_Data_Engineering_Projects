...
SELECT sd.skills,
      ...
      COUNT(jpf.*) AS skill_demand,
      ROUND(LN(COUNT(jpf.*)),1)  AS ln_skill_demand,
...
/*
A breakdown of the most optimal skills for Data Engineers, based on both high demand and high salaries:
